...
{% embed url="https://johnpantini.netlify.app" %}

{% embed url="https://johnpantini.vercel.app/" %}

Переходите по любой из ссылок. Если открыть сайт первый раз, появится плашка с уведомлением о том, что нужно обновиться. Нажмите на ссылку в этом уведомлении, чтобы зафиксировать текущую версию.
...
Когда все ключи собраны и введены в форму на странице облачных сервисов, нажимайте кнопку **Проверить и сохранить ключи**. По завершении операции появится уведомление с предложением обновить страницу, что и следует сделать. После этого приложение настроено и готово к наполнению пользовательским содержимым: API, брокерами, трейдерами, терминалами и т.п.
